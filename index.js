...
const rails = [
  ...
  },
  {
    ...
    name: 'Blog app',
    desc: `A web application that allows users to create, read, update,
          and delete blog posts, add and delete comments, like/unlike a post.
          Users can sign up, login, update and cancel their accounts.`,
    technologies: ['Rails', 'Postgres'],
    skills: ['javascript', 'ruby on rails', 'postgres', 'html'],
    skillsImg: 'images/icon-languages.png',
    desktopPopUpClose: 'images/desktop-popup-close.png',
...
const nodeProjects = document.querySelector('#node-cards');
